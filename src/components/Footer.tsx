        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              モダンなWebアプリケーションの開発と、ユーザーエクスペリエンスを重視したデザインに情熱を注いでいます。
            </p>
          </div>
          ...
          {/* Contact Info */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold">連絡先</h4>
            <div className="space-y-2 text-gray-400">
              <p>{personalInfo.contact.github.replace('https://', '')}</p>
              <p>{personalInfo.contact.website.replace('https://', '')}</p>
